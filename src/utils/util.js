/*
 * @Author: XIEXIAOJUN
 * @Date: 2020-12-11 17:22:10
 * @Description:
 * @FilePath: \fenghuangTour_officialManagerWebd:\workSpace\hezhangEC_synthesizeManagerWeb\src\utils\util.js
 * @.........
 */
/**
 * 时间格式化
...
export const downloadFile = (res, fName) => {
  ...
  if ('download' in document.createElement('a')) {
    ...
    link.download = fName + '_' + Date.now()
